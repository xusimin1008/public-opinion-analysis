...
csvfile_path = 'estate_corpus_guagnxi_raw_20151120.csv'
...
def export_csv():
    ...
    table_head = ['url', 'published_at', 'content']
    ...
    while True:
        ...
        for corpus in corpuses:
            table_row = [corpus.url, corpus.published_at, corpus.content.encode('utf-8')]
