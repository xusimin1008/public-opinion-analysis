...
class FangBhSpider(CrawlSpider):

    name = 'fang_bh'
    allowed_domains = ['news.bh.fang.com',]

    def __init__(self):

        url_format = 'http://news.bh.fang.com/news/gdxw/{}/{}.html'
        ...
        super(FangBhSpider, self).__init__()

    def parse_page(self, response):

        url = response.url
        if url.startswith('http://news.bh.fang.com'):
