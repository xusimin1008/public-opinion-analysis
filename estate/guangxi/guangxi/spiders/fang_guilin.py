...
class FangGuilinSpider(CrawlSpider):

    name = 'fang_guilin'
    allowed_domains = ['news.guilin.fang.com',]

    def __init__(self):

        url_format = 'http://news.guilin.fang.com/news/gdxw/{}/{}.html'
        ...
        super(FangGuilinSpider, self).__init__()

    def parse_page(self, response):

        url = response.url
        if url.startswith('http://news.guilin.fang.com'):
