...
class FangFangchenggangSpider(CrawlSpider):

    name = 'fang_fangchenggang'
    allowed_domains = ['news.fangchenggang.fang.com',]

    def __init__(self):

        url_format = 'http://news.fangchenggang.fang.com/news/gdxw/{}/{}.html'
        ...
        super(FangFangchenggangSpider, self).__init__()

    def parse_page(self, response):

        url = response.url
        if url.startswith('http://news.fangchenggang.fang.com'):
