...
class SinaGuilinSpider(CrawlSpider):

    name = 'sina_guilin'
    allowed_domains = ['guilin.house.sina.com.cn',]

    def __init__(self):
        #http://gx.house.sina.com.cn/oldnews/2015-11-16.shtml
        url_format = 'http://guilin.house.sina.com.cn/oldnews/{}.shtml'
        ...
        super(SinaGuilinSpider, self).__init__()

    def parse_page(self, response):

        url = response.url
        if url.startswith('http://guilin.house.sina.com.cn/'):
