...
class SinaGxSpider(CrawlSpider):

    name = 'sina_gx'
    allowed_domains = ['gx.house.sina.com.cn',]

    def __init__(self):
        #http://gx.house.sina.com.cn/oldnews/2015-11-16.shtml
        url_format = 'http://gx.house.sina.com.cn/oldnews/{}.shtml'
        ...
        super(SinaGxSpider, self).__init__()

    def parse_page(self, response):

        url = response.url
        if url.startswith('http://gx.house.sina.com.cn/'):
